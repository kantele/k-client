...
App.prototype._finishInit = function() {
  ...
  this._autoRefresh(!util.isProduction);
...
App.prototype._autoRefresh = function(refreshViews) {
  var app = this;
...
App.prototype.onRouteDone = function(app) {
  if (typeof window !== 'undefined' && (app.page && app.page.params && !app.page.params.backbutton)) {
